...
export default function Sidebar() {
  ...
  return (
    <aside className="w-72 min-h-screen bg-[#070312] text-white border-r border-white/10 flex flex-col">
      {/* Brand */}
      <div className="p-5 flex items-center gap-3">
        <div className="h-10 w-10 rounded-xl bg-white/5 border border-white/10 p-2 flex items-center justify-center">
          <img src={logo} alt="Ansari Tools" className="h-full w-full object-contain" />
        </div>
        <div>
      ...
      <div className="p-4 border-t border-white/10">
        ...
        {open && (
          <div className="mt-2 rounded-xl border border-white/10 bg-[#0b0520] overflow-hidden">
            ...
            <button className="w-full text-left px-4 py-3 text-sm text-red-300 hover:bg-white/10">
              Logout
            </button>
          </div>
        )}
